...
useradd carlos -m -c "Carlos" -s /bin/bash -p $(openssl paswd -crypt Senha123) -G GRP_ADM
useradd maria -m -c "Maria" -s /bin/bash -p $(openssl paswd -crypt Senha123) -G GRP_ADM
useradd joao -m -c "Joao" -s /bin/bash -p $(openssl paswd -crypt Senha123) -G GRP_ADM

useradd debora -m -s /bin/bash -p $(openssl paswd -crypt Senha123) -G GRP_VEN
